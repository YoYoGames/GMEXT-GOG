...
> **:warning: REQUIREMENT**
>
> Retrieve the user data first by calling [GOG_User_RequestUserData](#GOG_User_RequestUserData).
...
|key|string|The name of the property of the user data storage.
|userID|[GalaxyID](#GalaxyID)|The ID of the user. It can be omitted when reading own data.
...
@example
```gml
GOG_User_ReportInvalidAccessToken(accesstToken, "A hacker wanna be...");
```
The code above provides a simple usage example.
@func_end
...
> <span class="warning">WARNING These values shouldn&#39;t be used or changed and are to be passed back into the extension to perform the desired actions.
