@module Utils
@title Utils
@desc This is a module for managing various aspects of the framework (i.e.: overlay, images, services, ...).
@module_end
...
>
> For this call to work, the overlay needs to be initialized first. To check whether the overlay is initialized successfully, call [GOG_Utils_GetOverlayState](#GOG_Utils_GetOverlayState).
